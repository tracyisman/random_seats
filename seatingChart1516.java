...
/*
What if, instead of putting the students names into a swtich statement,
the names are put into an array...

Then you don't have to ask how many students are in the class, because you
can call array.length. But, how do you know which array to choose from?

I would need a switch statement to access the correct array. Which period
do you want to make a seating chart for? if A, then arrayToUse = APeriodArray
etc.

Is that change worth it? What else is would need to be changed?
